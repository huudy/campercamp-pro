          ...
          <GridContainer justifyContent='center'>
            <GridItem sm={3} className={classes.featuresShow}>
              <InfoArea
                ...
                description={
                  <p>
                    Enjoy the fluid grid system based on 12 columns. Material Kit PRO is built over
                    Material-UI and has all the benefits that the framework comes with.
                  </p>
                }
                icon={Grid}
                iconColor='gray'
              ...
              <InfoArea
                ...
                description={
                  <p>
                    ...
                    have to worry about customising the basic Material-UI design or generating new
                    components.
                  </p>
                }
                icon={AccessTime}
      ...
      <div className={classes.sectionTestimonials}>
        <div className={classes.container}>
          <GridContainer>
            <GridItem md={8} className={classNames(classes.mlAuto, classes.mrAuto)}>
              ...
              <h5 className={classes.description}>
                ...
                <b> 879,000+ web developers</b> in over <b> 1.588.000 Web Projects</b>. This is what
                some of them think:
              </h5>
            </GridItem>
          </GridContainer>
                  ...
                  <GridItem md={9} sm={9}>
                    <CardBody plain className={classes.alignLeft}>
                      ...
                      <p className={classes.cardDescription}>
                        ...
                        {"'"}t the same anymore, I just can{"'"}t describe it guys! Thank you for
                        this work!{'"'}
                      </p>
                    </CardBody>
                  </GridItem>
                ...
                <GridContainer>
                  ...
                  <GridItem md={9} sm={9}>
                    <CardBody plain className={classes.alignLeft}>
                      ...
                      <p className={classes.cardDescription}>
                        {'"'}Great kit! Used this for a client already and he is over the moon. Keep
                        up the good work Creative Tim! 10/10 for design, colours, and the feel of
                        the kit.
                        {'"'}
                      </p>
                    </CardBody>
          ...
          <div className={classes.ourClients}>
            <GridContainer justifyContent='center'>
              <GridItem md={3} sm={3}>
                <img src='/img/assets-for-demo/ourClients/vodafone.jpg' alt='vodafone' />
              </GridItem>
              <GridItem md={3} sm={3}>
                <img src='/img/assets-for-demo/ourClients/microsoft.jpg' alt='microsoft' />
              </GridItem>
              <GridItem md={3} sm={3}>
                <img src='/img/assets-for-demo/ourClients/harvard.jpg' alt='harvard' />
              </GridItem>
              <GridItem md={3} sm={3}>
                <img src='/img/assets-for-demo/ourClients/stanford.jpg' alt='stanford' />
              </GridItem>
            </GridContainer>
          </div>
        </div>
