        ...
        <GridContainer justifyContent='center'>
          <GridItem md={5} lg={5} sm={12} xs={12}>
            ...
            <h5 className={classes.description}>
              All the Material-UI components that you need in a development have been re-design with
              the new look. Besides the numerous basic elements, we have also created additional
              classes. All these items will help you take your project to the next level.
            </h5>
          </GridItem>
