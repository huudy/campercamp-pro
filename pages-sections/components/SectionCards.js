          ...
          <div className={classes.container}>
            ...
            <GridContainer>
              <GridItem xs={12} sm={6} md={6} lg={4}>
                <div
                  className={
                    classes.rotatingCardContainer + ' ' + classes.manualRotate + ' ' + activeRotate1
                  }
                >
                  <Card className={classes.cardRotate}>
                    <div className={classes.front}>
              ...
              <GridItem xs={12} sm={6} md={6} lg={4}>
                <div
                  className={
                    classes.rotatingCardContainer + ' ' + classes.manualRotate + ' ' + activeRotate2
                  }
                >
                  <Card className={classes.cardRotate}>
                    <div
                    ...
                    >
                      <CardBody background className={classes.cardBodyRotate}>
                        ...
                        <div className={classes.textCenter}>
                          ...
                          <br />
                          <br />
                          <Button round color='danger' onClick={() => setActiveRotate2('')}>
                            <Refresh /> Back...
                          </Button>
                        </div>
                      </CardBody>
              ...
              <GridItem xs={12} sm={6} md={6} lg={4}>
                <div
                  className={
                    classes.rotatingCardContainer + ' ' + classes.manualRotate + ' ' + activeRotate3
                  }
                >
                  <Card className={classes.cardRotate}>
                    ...
                    <div className={classes.back + ' ' + classes.wrapperWarning}>
                      <CardBody className={classes.cardBodyRotate}>
                        ...
                        <div className={classes.textCenter}>
                          ...
                          <br />
                          <br />
                          <Button round color='white' onClick={() => setActiveRotate3('')}>
                            <Refresh /> Rotate
                          </Button>
                        </div>
                      </CardBody>
          ...
          <GridContainer>
            <GridItem xs={12} sm={7} md={7}>
              <div className={classes.title}>
                ...
                <h4>
                  Material Kit PRO is coming with the famous colored shadows. That means each image
                  from the cards is getting an unique color shadow. You don{"'"}t have to do
